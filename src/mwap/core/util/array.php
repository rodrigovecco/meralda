...
function mw_array2list($data,$parametros=NULL){
	...
	$fnc_si_array=false;
	if(isset($parametros["fnc_si_array"]) and $parametros["fnc_si_array"]){
	...
	$fnc_si_dato=false;
	if(isset($parametros["fnc_si_dato"]) and $parametros["fnc_si_dato"]){
	...
	if (isset($parametros["nuevo"]) and $parametros["nuevo"]){
		$r.="</ul>";
	}
	return $r;
}
